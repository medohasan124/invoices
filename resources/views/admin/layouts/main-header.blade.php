					...
					<div class="main-header-right">
							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/'.session("lang").'_64.png')}}" alt="img" style='width: 2rem; height: 2rem;'></span>
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto">English</strong>
										</div>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{url('admin/en')}}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/en_64.png')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">English</span>
											</div>
										</a>
										<a href="{{url('admin/ar')}}" class="dropdown-item d-flex">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/ar_64.png')}}" alt="img"></span>
											<div class="d-flex">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								<a class="new nav-link NewnoTification" href="#">
								...
								<span class=" pulse d-none"></span> 
								<span class="numbers badge badge-success d-none" style='position: absolute;
												    left: 0;
												    top: 0;'>
								...
								<div class="dropdown-menu">
									...
									<div class="main-notification-list Notification-scroll">
										...
										@foreach(auth()->user()->unreadNotifications as $notification)
     											...
     											<a class="d-flex p-3 border-bottom" href="{{url('admin/invoice/').'/'.$notification->data['id'] }}" style='background: #e0e0e0;'>
										...
										@foreach(auth()->user()->readNotifications as $read)
										       ...
										       <a class="d-flex p-3 border-bottom" href="{{url('admin/invoice/').'/'.$read->data['id'] }}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">
													...
													{{ $read->data['data'] }}
													<span class='text-primary'>{{ $read->data['name'] }}</span>
												</h5>
												<div class="notification-subtext">10 hour ago</div>
											</div>
											<div class="mr-auto" >
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a href="{{route('logout_admin')}}" class="dropdown-item">
                                     <i class="bx bx-logout"></i>{{trans('admin.logout')}}
                                    </a>
...
<script>
	var set = setInterval(function(){
		...
		$.ajax({
			...
			methods: 'get' ,
			data: {name:'medo' , _token:'{{session("_token")}}'} ,
