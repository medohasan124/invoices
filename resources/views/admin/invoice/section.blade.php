...
<!-- Modal effects -->
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body" style='background: #dfe1e4'>
						...
						{{Form::label(trans('admin.section_name'))}}
						{{Form::text('name' , null, ['class' => 'form-control' ,"autocomplete"=>"off" ,'id' => 'section_name'])}}
						
						<br>
						{{Form::label(trans('admin.section_disc'))}}
						{{Form::textarea('description' ,null, ['class' => 'form-control','autocomplete'=>"off" ,'id' => 'section_disc'])}}
					</div>

						<div class="modal-footer">

						<button class=" btn  btn-success create_section">{{trans('admin.sure')}}</button>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body" style='background: #dfe1e4'>
						...
						<br>
						{{Form::open(['method' => 'PUT' , 'url' => 'admin/section'])}}
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-footer">
						...
						{{Form::open(['method' => 'delete' , 'url' => 'admin/section/destroy'])}}
						{{-- <button class="btn ripple btn-danger single_modal_delete " type="button">{{trans('admin.delete')}}</button> --}}
		...
		<!-- End Modal effects-->
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('admin.sections')}}</h4>
						</div>
					</div>
    ...
    @endif
							...
							<div class="card-body">
								<div class="table-responsive">
										{{Form::open(['id' =>'del' ,'method' => 'delete' , 'url' => 'admin/section/destroy'])}}
									<table id="example" class="table key-buttons text-md-nowrap text-center">
										<thead>
											<tr>
												...
												<th class="border-bottom-0">{{trans('admin.discription')}}</th>
												
												<th class="border-bottom-0">{{trans('admin.addBy')}}</th>
												
												<th class="border-bottom-0">{{trans('admin.created_at')}}</th>
												@can('section-edit')
										...
										<tbody>
											...
											@foreach($data as $row)
												...
												@can('section-edit')
												<td><a href="#" class='btn btn-success edit_section' id='{{$row->id}}' data-name='{{$row->name}}' data-discrption='{{$row->description}}'><i class='fas fa-edit '></i></a></td>
												@endcan
												@can('section-delete')
...
<script>
	...
	$('.edit_section').click(function(){
		...
		$('#modaldemo9 form').attr('action' , '{{url("admin/section")}}/'+id);
		console.log(name);
	});
</script>
@endsection