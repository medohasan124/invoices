			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-footer">
						...
						{{Form::open(['method' => 'delete' , 'url' => 'admin/roles/destroy'])}}
					...
					<i class="mdi mdi-dots-horizontal text-gray"></i>
							...
							<div class="card-body">
								<div class="table-responsive">
										{{Form::open(['id' =>'del' ,'method' => 'delete' , 'url' => 'admin/roles/destroy'])}}
									<table id="example" class="table key-buttons text-md-nowrap text-center">
										...
										<tbody>
											...
											@foreach($data as $row)
												...
												@can('role-edit')
												 <td><a href="{{route('roles.edit',$row->id)}}" class='btn btn-success edit_section' data-name='{{$row->name}}' href="#" id='{{$row->id}}' ><i class='fas fa-edit '></i></a></td>
												 @endcan
												 @can('role-delete')
...
<script>
	...
	$('.edit_section').click(function(){
		...
		$('#modaldemo9 form').attr('action' , '{{url("admin/roles")}}/'+id);
