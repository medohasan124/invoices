...
<div class="alert alert-success" role="alert">
	...
	<div class="row">
		<div class="col-md-12 col-lg-12 col-xl-7">
				...
				{{Form::open(['method' => 'put' , 'url' => 'admin/users/'.$data->id])}}
					...
					<span class='badge badge-warning'>Password not required</span>
					{{Form::password('password' ,['class' => 'form-control'])}}
					

					{{Form::label(trans('admin.status'))}}

					{{Form::select('status' ,['active' ,'disactive'], $data->status ,['class' => 'form-control']
    )}}


					{{Form::label(trans('admin.member'))}}

					{{Form::select('member' ,$roles , $data->member , ['class' => 'form-control'] )}}
